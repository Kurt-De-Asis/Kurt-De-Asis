        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="#services" className="block text-foreground/70 hover:text-violet-400 transition-colors">
                Services
              </a>
              <a href="#experience" className="block text-foreground/70 hover:text-violet-400 transition-colors">
                Experience
              </a>
          ...
          {/* Social Links */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-violet-400">Connect</h3>
            <div className="flex space-x-4">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
              >
                <svg className="w-5 h-5 text-violet-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Hire Me */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-violet-400">Work With Me</h3>
            <div className="space-y-2">
              <a href="#services" className="block text-foreground/70 hover:text-violet-400 transition-colors">
              ...
              <a href="#remote" className="block text-foreground/70 hover:text-violet-400 transition-colors">
                Remote Work Setup
              </a>
              <a href="#contact" className="inline-block mt-2 px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white text-sm font-medium rounded-lg transition-colors">
                Hire Me
              </a>
            </div>
          </div>
