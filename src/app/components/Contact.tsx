...
const Contact = () => {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.message.trim()) next.message = 'Please write a message.';
    setErrors(next);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Honeypot anti-spam: silently drop submissions from bots
    if (honeypot) {
  ...
  const inputClass = (field: keyof FormState) =>
    `w-full px-4 py-3 bg-black/60 border rounded-lg text-foreground placeholder-foreground/50 focus:outline-none focus:ring-2 focus:ring-violet-500/20 transition-all ${
      errors[field]
        ? 'border-red-500/60'
        : 'border-violet-600/30 focus:border-violet-500'
    }`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            — or make your workflow easier. I&apos;m available for development projects,
            virtual assistance, and remote opportunities.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-violet-400">Get in Touch</h3>
              <p className="text-foreground/70">
                Whether you have a development project, need executive support, or want to discuss
                a remote opportunity — I&apos;d love to hear from you.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <svg className="w-6 h-6 text-violet-400" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`${inputClass('name')} pl-10 ${errors.name ? '!border-red-500/60' : ''}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`${inputClass('email')} pl-10 ${errors.email ? '!border-red-500/60' : ''}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`${inputClass('subject')} ${errors.subject ? '!border-red-500/60' : ''}`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={6}
                      className={`${inputClass('message')} pl-10 ${errors.message ? '!border-red-500/60' : ''}`}
                      placeholder="Tell me about your project, support needs, or just say hello!"
